...
def generate_short_answer(question: str, top_k: int = 2):
    ...
    if not context_chunks:
        return {"answer": "Bilgi almak için teknokent yetkilisi ile görüşebilirsiniz. İletişim no: (0264) 346 02 02", "sources": []}
    ...
    # Kaynakta bilgi yoksa default cevap
...
@app.get("/")
def read_index():
    # HTML dosyanın yolu, örn: "index.html" projenin kök dizininde olmalı
